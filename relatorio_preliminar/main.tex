...
\textit{Web services} é um tema já muito explorado na area de engenharia de \textit{software} devido à sua constante evolução; existindo, portanto, vários artigos e \textit{papers} que propõe e exploram diferentes metodologias e técnicas de implementação.
